<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RentarVehiculo.aspx.cs" Inherits="WebProyectoFinalDesarrolloSoftware.ProyectoFinal.RentarVehiculo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">        
    <p class="text-center">
        <div class="text-center">
            <strong><span style="font-size: x-large">ADMINISTRACION DE RENTAS</span></strong><br />
            </div>
        <table class="nav-justified">
            ...
            <span style="font-size: x-large">RENTAR VEHICULO</span><br />
            ...
            <tr>
                <td class="text-center" colspan="2"><strong>
                    ...
                    PRECIO 90 MIL POR DIA</span></strong></td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td class="text-center" colspan="2">
                    ...
                    PRECIO 65 MIL POR DIA</span></strong></td>
            </tr>
            <tr>
                <td class="text-left" colspan="2">
                    <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>C</strong><span style="font-weight: bold">HEVROLET SPARK&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; HYUNDAI i10&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; RENAULT SANDERO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; RENAULT TWINGO&nbsp;&nbsp;&nbsp; <br />
            ...
            <tr>
                <td class="text-left" style="font-size: large; width: 218px"><strong>
                    <asp:Label ID="lblEmpleado" runat="server" Visible="False">EMPLEADO</asp:Label>
                    </strong></td>
                <td class="text-left">
                    <asp:DropDownList ID="cboEmpleado" runat="server" BackColor="#0066FF" ForeColor="White" style="font-size: medium" Visible="False" Width="250px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="text-left" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnConsultarPrecio" runat="server" BackColor="#0066FF" ForeColor="White" OnClick="btnConsultarPrecio_Click" style="font-size: medium; margin-left: 0" Text="CONSULTAR PRECIO DE LA RENTA" Visible="False" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 218px">
                    <asp:Button ID="btnRentarVehiculo" runat="server" BackColor="#0066FF" ForeColor="White" OnClick="btnRentarVehiculo_Click" style="font-size: medium" Text="RENTAR VEHICULO" Visible="False" Width="250px" />
                </td>
                <td class="text-left">
                    <asp:Button ID="btnActualizarRenta" runat="server" BackColor="#0066FF" ForeColor="White" style="font-size: medium" Text="ACTUALIZAR RENTA" Visible="False" Width="250px" OnClick="btnActualizarRenta_Click" />
                </td>
            </tr>
            <tr>
                <td style="width: 218px">
                    &nbsp;</td>
                <td>
                    <asp:Button ID="btnEliminarRenta" runat="server" BackColor="#0066FF" ForeColor="White" style="font-size: medium" Text="ELIMINAR RENTA" Visible="False" Width="250px" OnClick="btnEliminarRenta_Click" />
                </td>
            </tr>
            <tr>
                <td style="width: 218px">
            ...
            <tr>
                <td style="font-size: x-large;" class="text-center" colspan="2">
                    <strong>EDITAR UNA RENTA</strong></td>
            </tr>
            <tr>
                <td style="font-size: x-large;" class="text-center" colspan="2">
                    &nbsp;</td>
            ...
            <tr>
                <td colspan="2" class="text-center">
                    <asp:GridView ID="grdRegistroRenta" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" OnSelectedIndexChanged="grdRegistroRenta_SelectedIndexChanged">
                        <Columns>
